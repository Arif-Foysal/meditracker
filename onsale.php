<!-- 
ToDo
-[ ] id&quantity both fields should be filled, otherwise send alert
-[ ] 
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="post" action="#">
            ...
            <button type="submit" name="submit" class="btn btn-success">Add To Sale Invoice</button>
          </form>
        </div>
      </div>
      ...
      <?php
        ...
        echo '</tbody></table>';
          ...
          if(isset($_POST['submit'])){
            //experimental- grab the quantity from stock with drugid
            //if it is less than required quantity
            //show alert
            $drugidtest= $_POST["drugid"];
            $queryy = "SELECT quantity
          FROM storedDrug
          WHERE drugID = $drugidtest";

$result_ = mysqli_query($conn, $queryy);
...
//experiment end
            ...
            echo '<script>window.location.href = "saleinvoice.php";</script>';
      ...
      exit();
          ...
          ?>
          <br>
          <a href="saleinvoice.php"> <button type="submit" name="submit" class="btn btn-danger">Go Back</button></a>
